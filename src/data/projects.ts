...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Built a real-time ride-hailing simulation with rider requests and driver location updates.",
    problem:
      "Complex backend logic and real-time matching in ride-hailing apps is hard to visualize.",
    solution:
      "Created microservices with geo-matching, message queues, and a web dashboard.",
    results:
      "Demonstrated a scalable system design, helping visualize real-world ride-hailing operations.",
    techStack: ["Java", "Spring Boot", "React", "Leaflet", "CSS", "PostgreSQL", "Redis", "Elasticsearch", "RabbitMQ", "Docker"],
    category: "Full-Stack, Backend",
